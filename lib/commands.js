...
Send me the AIMA URL from your submission confirmation document (usually found in the QR code). The URL must be from aima.gov.pt domain.`;
  ...
  bot.onText(/\/status(?:@\w+)?$/, async (msg) => {
    ...
    try {
      ...
      status += '🕐 Automatic checks at 10:00 and 22:00 daily';
...
📨 To start monitoring:
Send me the AIMA URL from your submission confirmation document (found in QR code). The bot monitors these fields at 10:00 and 22:00 daily:
📅 Última Atualização
📋 Situação AT/SS
🏛️ Estado
