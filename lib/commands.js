...
function urlRejectionMessage(err) {
  ...
  if (err instanceof TrackingPortalError) {
    return '❌ This URL is from the AIMA process/card tracking portal (contactenos.aima.gov.pt), which is a different system I can\'t monitor.\n\n📋 Please send the URL from the renewals portal (portal-renovacoes.aima.gov.pt), typically found in the QR code of your submission confirmation document.';
  }
